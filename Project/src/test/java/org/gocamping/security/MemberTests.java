...
//
  public void testInsertMember() {
    ...
    String sql = "insert into member_tbl(email, password, name, gender) values (?,?,?,0)";
    ...
    for(int i = 0; i < 3; i++) {
      ...
      try {
        ...
        if(i == 2) {
          ...
          pstmt.setString(2, pwencoder.encode("manager"));
 ...
 @Test
  public void testInsertAuth() {
    ...
    String sql = "insert into member_auth_tbl (email, auth) values (?,?)";
