...
================================================== -->
  ...
  <!-- 예약페이지 -->
  <link rel="stylesheet" href="/resources/jongwoon/css/resPage.css">
...
<!-- kakaomap -->
<link rel="stylesheet"
	href="/resources/heejin/constra/css/maps/kakaomap.css">
                ...
                <li>
                  ...
                  <div class="logoarea">
                    ...
                    <h1 id="logo" class="text-center ml-5">
                      <a href="/main"><span class="skip"></span></a>
                    </h1>
                  </div>
                </li>
              </ul>
                  ...
                  <div id="navbar-collapse" class="collapse navbar-collapse" style="z-index: 99999;">
                    <ul class="nav navbar-nav mr-auto">
                      <li class="nav-item dropdown">
                        <a href="/camp/search" class="nav-link dropdown-toggle" data-toggle="dropdown">캠핑GO <i
                            class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="/camp/search">캠핑장 검색</a></li>
                          <li><a href="/camp/res">캠핑장 예약</a></li>
                          <li><a href="#">이달의 추천 캠핑장</a></li>
                      ...
                      <li class="nav-item dropdown ml-5">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">캠핑플러스 <i
                            class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="/board/list">캠핑소식</a></li>
                          <li><a href="#">안전한캠핑즐기기</a></li>
                          <li><a href="#">캠핑장 안전수칙 동영상</a></li>
                        </ul>
                      </li>

                      <li class="nav-item dropdown ml-5">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">고객센터 <i
                            class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="#">공지사항</a></li>
                          <li><a href="#">캠핑장정보 수정요청</a></li>
                          <li><a href="#">등록 야영장 확인 문의</a></li>
                          <li><a href="#">캠핑장 공지사항</a></li>
                          <li class="dropdown-submenu">
                            <a href="#!" class="dropdown-toggle" data-toggle="dropdown">예비메뉴</a>
                            <ul class="dropdown-menu">
                              <li><a href="#">예비 Menu 1</a></li>
                              <li><a href="#">예비 Menu 2</a></li>
                              <li><a href="#">예비 Menu 3</a></li>
                            </ul>
                          </li>
                        </ul>
                      </li>
                      ...
                      <!-- <li class="nav-item dropdown ml-5">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">예비메뉴 <i
                            class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="#">예비메뉴</a></li>
                          <li><a href="#">예비메뉴</a></li>
                      ...
                      <li class="nav-item ml-5"><a class="nav-link" href="c#">Contact</a></li> -->
                    </ul>
                  </div>
                </nav>
              </div>
