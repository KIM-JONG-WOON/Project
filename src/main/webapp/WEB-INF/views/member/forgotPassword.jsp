                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">비밀번호를 분실했습니까?</h1>
                                        <p class="mb-4">초기화 비밀번호를 알려드리겠습니다. <br> 아래 입력란에 이메일을 입력해주세요.</p>
                                    </div>
                                    <form class="user">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="/member/memberRegister.html">회원가입</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="/member/login.html">로그인</a>
                                    </div>
                                </div>
                            </div>
                        </div>
