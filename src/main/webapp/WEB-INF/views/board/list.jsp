      ...
      <div class="col-md-12 board">
        <div class="panel panel-default">
          <div class="panel-heading regBtn">
  			<button id='regBtn' type="button" class="btn btn-dark pull-right">+</button>
 		  </div>
        </div>
      </div>
    </div>
            ...
            <div class='pull-right'>
              <ul class="pagination">
                ...
                <c:forEach var="num" begin="${pageMaker.startPage }" end="${pageMaker.endPage }">
                  <li class='paginate_button' style='${pageMaker.cri.pageNum == num ? "font-weight:bold":""}'><a href="${num}">${num }</a></li>
                </c:forEach>
